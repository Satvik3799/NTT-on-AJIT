...
.LFB0:
	.file 1 "/home/ajit/ajit-toolchain/AjitPublicResources/tools/ajit_access_routines_mt/src/ajit_access_routines.c"
	.loc 1 10 0
	.cfi_startproc
	save	%sp, -104, %sp
.LCFI0:
...
.L37:
	...
	ld	[%fp+68], %g2
	stb	%g1, [%g2]
	.loc 1 166 0 is_stmt 1 discriminator 9
	ld	[%fp-4], %g1
	srl	%g1, 28, %g1
	and	%g1, 3, %g1
	stb	%g1, [%fp-5]
...
.L43:
	...
	ld	[%fp+68], %g2
	stb	%g1, [%g2+1]
	.loc 1 169 0 is_stmt 1 discriminator 9
	ld	[%fp-4], %g1
	srl	%g1, 26, %g1
	and	%g1, 3, %g1
	mov	%g1, %g2
...
.L175:
	...
	st	%g1, [%fp-8]
	.loc 1 762 0 is_stmt 1 discriminator 3
	ldub	[%fp+68], %g1
	and	%g1, 0xff, %g1
	cmp	%g1, 0
	be	.L176
...
.LCFI62:
	...
	mov	%g2, %o2
	mov	%g1, %o3
	call	calculate_baud_control_values_for_uart, 0
	 nop
	.loc 1 811 0
	ld	[%fp+72], %g1
	cmp	%g1, 0
...
.LCFI76:
	...
	mov	%g2, %o2
	mov	%g1, %o3
	call	__ajit_do_spi_transfer_inner__, 0
	 nop
	mov	%o0, %g1
	and	%g1, 0xff, %g1
	.loc 1 1059 0
...
.Letext0:
	...
	.file 3 "/home/ajit/ajit-toolchain/AjitPublicResources/tools/ajit_access_routines_mt/include/ajit_access_routines.h"
...
.LASF178:
	.asciz	"__ajit_write_gpio_32_via_vmap__"
.LASF164:
	.asciz	"deselect_after_transfer"
.LASF185:
	.asciz	"__ajit_fsqrts__"
.LASF96:
	.asciz	"__ajit_read_serial_tx_register_via_bypass__"
.LASF186:
...
.LASF172:
	.asciz	"gpio_dev_id"
.LASF152:
	.asciz	"__ajit_write_irc_control_register_via_bypass__"
.LASF105:
	.asciz	"enable_intr"
.LASF166:
	.asciz	"__ajit_configure_spi_master_via_bypass___"
.LASF94:
	.asciz	"__ajit_read_serial_control_register_via_bypass__"
.LASF25:
	.asciz	"has_two_threads"
.LASF162:
	.asciz	"__ajit_do_spi_transfer_via_bypass__"
.LASF154:
	.asciz	"__ajit_write_irc_control_register_via_vmap__"
.LASF130:
	.asciz	"__ajit_write_serial_baud_frequency_register_via_vmap__"
.LASF148:
	.asciz	"rx_reg_addr"
.LASF100:
	.asciz	"__ajit_write_serial_baud_frequency_register_via_bypass__"
.LASF7:
	.asciz	"unsigned int"
.LASF97:
	.asciz	"__ajit_read_serial_rx_register_via_bypass__"
.LASF67:
	.asciz	"core_id"
.LASF21:
	.asciz	"log_mmu_l2_tlb_size"
.LASF39:
	.asciz	"icache_miss_count"
.LASF19:
	.asciz	"l1_icache_hit_latency"
.LASF59:
	.asciz	"rwbar"
.LASF120:
...
.LASF151:
	.asciz	"__ajit_serial_set_uart_reset_inner__"
.LASF189:
	.asciz	"__ajit_clear_all_gp_registers__"
.LASF18:
	.asciz	"l1_dcache_hit_latency"
.LASF27:
	.asciz	"AjitHwThreadDescriptor"
.LASF168:
	.asciz	"__ajit_configure_spi_master_via_vmap___"
.LASF44:
	.asciz	"scratch_pad_index"
.LASF40:
	.asciz	"AjitPerThreadPerformanceCounters"
.LASF74:
	.asciz	"clock_cycles"
.LASF14:
	.asciz	"l1_dcache_size_in_KB"
.LASF36:
	.asciz	"stream_mispredict_count"
.LASF58:
	.asciz	"device_id"
.LASF6:
	.asciz	"uint32_t"
.LASF160:
	.asciz	"__ajit_read_spi_master_register_via_bypass__"
.LASF115:
...
.LASF180:
	.asciz	"__ajit_write_gpio_32_via_bypass__"
.LASF66:
...
.LASF114:
	.asciz	"__ajit_serial_gets_via_bypass__"
.LASF92:
	.asciz	"__ajit_read_timer_control_register_via_vmap__"
.LASF142:
	.asciz	"addr_blimit"
.LASF149:
	.asciz	"__ajit_serial_puts_inner__"
.LASF79:
	.asciz	"value"
.LASF68:
	.asciz	"thread_id"
.LASF20:
	.asciz	"log_mmu_l3_tlb_size"
.LASF90:
	.asciz	"__ajit_read_timer_control_register_via_bypass__"
.LASF98:
	.asciz	"__ajit_write_serial_baud_limit_register_via_bypass__"
.LASF138:
	.asciz	"ctrl_reg_addr"
.LASF80:
...
.LASF158:
	.asciz	"reg_val"
.LASF134:
	.asciz	"__ajit_serial_configure_inner__"
.LASF153:
	.asciz	"__ajit_read_irc_control_register_via_bypass__"
.LASF140:
	.asciz	"serial_device_index"
.LASF125:
	.asciz	"__ajit_serial_set_uart_reset_via_vmap__"
.LASF157:
	.asciz	"reg_id"
.LASF109:
	.asciz	"reset_val"
...
.LASF165:
	.asciz	"__ajit_do_spi_transfer_via_vmap__"
.LASF71:
	.asciz	"__ajit_read_cycle_count_register_low__"
.LASF29:
	.asciz	"__AjitPerThreadPerformanceCounters"
.LASF13:
	.asciz	"char"
.LASF112:
	.asciz	"__ajit_serial_puts_via_bypass__"
.LASF99:
	.asciz	"__ajit_read_serial_baud_limit_register_via_bypass__"
.LASF51:
	.asciz	"ajit_write_to_scratch_pad"
.LASF15:
	.asciz	"l1_icache_size_in_KB"
.LASF103:
	.asciz	"enable_tx"
.LASF129:
	.asciz	"__ajit_read_serial_baud_frequency_register_via_vmap__"
.LASF5:
	.asciz	"uint8_t"
.LASF53:
	.asciz	"status"
.LASF30:
	.asciz	"executed_instruction_count"
.LASF88:
...
.LASF38:
	.asciz	"icache_access_count"
.LASF62:
	.asciz	"__ajit_read_core_thread_id_word__"
.LASF63:
	.asciz	"retval"
.LASF102:
	.asciz	"__ajit_serial_configure_via_bypass__"
.LASF2:
	.asciz	"long long int"
.LASF143:
	.asciz	"addr_bfreq"
...
.LASF181:
	.asciz	"__ajit_init_thread_performance_counters"
.LASF144:
	.asciz	"__ajit_serial_putchar_inner__"
.LASF72:
...
.LASF65:
	.asciz	"descr"
.LASF192:
	.asciz	"/home/ajit/ajit-toolchain/AjitPublicResources/tools/ajit_access_routines_mt/src/ajit_access_routines.c"
.LASF176:
	.asciz	"cmd_to_master"
.LASF85:
...
.LASF136:
	.asciz	"dev_id"
.LASF127:
	.asciz	"__ajit_read_serial_baud_limit_register_via_vmap__"
.LASF64:
	.asciz	"ajit_read_thread_descriptor"
.LASF50:
	.asciz	"div_value"
.LASF23:
	.asciz	"log_mmu_l0_tlb_size"
.LASF82:
	.asciz	"__ajit_store_word_to_physical_address__"
.LASF128:
	.asciz	"__ajit_write_serial_baud_limit_register_via_vmap__"
.LASF31:
	.asciz	"skipped_instruction_count"
.LASF171:
	.asciz	"__ajit_gpio_xfer__"
.LASF110:
	.asciz	"__ajit_serial_putchar_via_bypass__"
.LASF24:
	.asciz	"has_noncacheable_bypass_path"
.LASF35:
	.asciz	"store_miss_count"
.LASF1:
	.asciz	"short int"
.LASF167:
	.asciz	"clk_divide_count"
.LASF17:
	.asciz	"log_icache_associativity"
.LASF118:
...
.LASF182:
	.asciz	"__ajit_sample_thread_performance_counters"
.LASF83:
...
.LASF193:
	.asciz	"__ajit_ta_0__"
.LASF89:
	.asciz	"__ajit_write_timer_control_register_via_bypass__"
.LASF169:
	.asciz	"__ajit_do_spi_transfer_inner__"
.LASF84:
...
.LASF42:
	.asciz	"ret_val"
.LASF131:
	.asciz	"calculate_baud_control_values_for_uart"
.LASF156:
	.asciz	"__ajit_write_spi_master_register_via_bypass__"
.LASF174:
	.asciz	"retry_limit"
.LASF3:
	.asciz	"unsigned char"
...
.LASF183:
	.asciz	"base_addr"
.LASF16:
	.asciz	"log_dcache_associativity"
.LASF47:
	.asciz	"ajit_configure_i2c_master"
.LASF150:
	.asciz	"__ajit_serial_gets_inner__"
.LASF48:
	.asciz	"clock_frequency"
.LASF0:
	.asciz	"signed char"
.LASF133:
	.asciz	"baud_frequency"
.LASF135:
	.asciz	"use_vmap"
.LASF33:
	.asciz	"load_miss_count"
.LASF4:
	.asciz	"short unsigned int"
.LASF147:
	.asciz	"__ajit_serial_getchar_inner__"
.LASF122:
	.asciz	"__ajit_serial_puts_via_vmap__"
.LASF175:
	.asciz	"status_reg"
.LASF95:
	.asciz	"__ajit_write_serial_tx_register_via_bypass__"
.LASF170:
	.asciz	"spin_count"
.LASF108:
	.asciz	"__ajit_serial_set_uart_reset_via_bypass__"
.LASF177:
	.asciz	"__ajit_read_gpio_32_via_vmap__"
.LASF91:
	.asciz	"__ajit_write_timer_control_register_via_vmap__"
.LASF106:
	.asciz	"__ajit_serial_set_baudrate_via_bypass__"
.LASF187:
	.asciz	"__ajit_fitos__"
.LASF179:
	.asciz	"__ajit_read_gpio_32_via_bypass__"
.LASF107:
	.asciz	"baud_rate"
.LASF86:
	.asciz	"__ajit_load_word_mmu_bypass__"
.LASF101:
	.asciz	"__ajit_read_serial_baud_frequency_register_via_bypass__"
.LASF26:
	.asciz	"implements_isa_64"
.LASF54:
	.asciz	"ajit_i2c_master_write_command"
.LASF28:
	.asciz	"__AjitHwThreadDescriptor"
