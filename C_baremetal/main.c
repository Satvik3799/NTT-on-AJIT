...
void ntt_thread(void* args){
    // ee_printf("[INFO] : NTT_THREAD entered\n");
    ee_printf("[INFO] : NTT_THREAD entered\n");
    ...
    // ee_printf("[INFO]   :   Performing NTT on:\n");
    ...
    // ee_printf("[INFO] : NTT_THREAD exited\n");
    ee_printf("[INFO] : NTT_THREAD exited\n");
...
void ntt_top(uint32_t *x, uint32_t *psis){
    ...
    ee_printf("[INFO] : NTT_TOP Entered\n");

    // for(i = 0; i < 128; i++){
    //     ee_printf("X Array [%d] - %d\n", i, x[i]);
    // }

    // for(i = 0; i < 128; i++){
    //     ee_printf("psis Array [%d] - %d\n", i, psis[i]);
    // }
    ...
    // for(i = 0; i < 128; i++){
    //     ee_printf("xe Array [%d] - %d\n", i, xe[i]);
    // }

    // for(i = 0; i < 128; i++){
    //     ee_printf("xo Array [%d] - %d\n", i, xo[i]);
    // }
	...
	{
        // ee_printf("[INFO] : NTT_TOP still running 1\n");
	};   
	...
	{
        ee_printf("[INFO] : NTT_TOP waiting for response\n");
	}

    ee_printf("[INFO] : NTT_TOP Exiting\n");
}
...
void setup()
{
	...
	ee_printf("[INFO] : Init channel.\n");
	// initialize scoreboard.
	initChannel(&tc, 1);

	ee_printf("[INFO] : initChannel %d: status=%d.\n", tc.id, tc.status);
}
...
int main_00()
{
    ...
    ee_printf("[INFO] : --------------------------------------------------------------------------------\n");
    ee_printf("[INFO] : ---------------------------Logs Start Here--------------------------------------\n");
    ee_printf("[INFO] : --------------------------------------------------------------------------------\n");
	...
	ee_printf("[-- RESULT --] : Single thread Times: %f\n", (double) (t00_1 - t00_0));  
    // ee_printf("[-- NTT RESULT Array --] \n");
	...
	ee_printf("[-- RESULT --] : Dual thread Times: %f\n", (double) (t1 - t0)); 
	// close the channel..
...
int main_01 ()
{
	...
	ee_printf("[INFO] : Entered main_01\n");
